...
function Podcast() {
	return (
		<div className="bg-primary flex flex-col justify-center items-center  gap-3 w-full h-content py-6">
			<div className="text-black text-center text-4xl md:text-5xl font-medium font-playfair flex flex-col justify-center items-center">
				TOP PODCAST EPISODES
			</div>
			<div className="md:w-96 w-40 h-[1px] bg-black"></div>
			<div className="flex md:flex-nowrap flex-wrap items-center justify-around w-full h-full gap-6 md:gap-0 pt-6 pb-16 px-10 sm:px-32 md:px-0">
