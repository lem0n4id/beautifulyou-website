	...
	return (
		<div className="bg-primary h-64 w-full text-josefin flex justify-evenly items-center md:flex-nowrap flex-wrap py-10 ">
			...
			<div className="flex items-start md:items-end h-[7rem] gap-2">
				...
				<a
					className="text-black "
					href="https://open.spotify.com/show/6BoCbJ8lvEvFTprfpo25Oc"
					target="_blank"
				>
					<svg
						className="h-8 w-8"
				...
				<a
                    className="text-black "
					href="https://www.linkedin.com/company/beautiful-you23/"
					target="_blank"
				>
					<svg
                    className="h-8 w-8"
				...
				<a
					className="text-black "
					href="https://www.instagram.com/beautifulyou.pod/"
					target="_blank"
				>
					<svg
						className="h-8 w-8"
